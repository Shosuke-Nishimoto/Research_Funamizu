[X,cmap] = imread("D:\Nishimoto_data\ISOI\230922_ISOI_S5_1\230922_ISOI_S5_1_tif\230922_ISOI_S5_1_X1.tif");
X = imresize(X, 1/8);
X = ind2rgb(X,cmap);
figure;
imshow(X)
%%
imds = imageDatastore("D:\Nishimoto_data\ISOI\230922_ISOI_S5_1\230922_ISOI_S5_1_tif");
im_list = imds.Files;
...
%%
save_filename = "230922_ISOI_S5_1";
...
[X,cmap] = imread("D:\Nishimoto_data\ISOI\230921_ISOI_S1_2\230921_ISOI_S1_2_tif\230921_ISOI_S1_2_X1.tif");
X = imresize(X, 1/8);
X = ind2rgb(X,cmap);

load('230921_ISOI_S1_2.mat')
load('NI_21-Sep-2023_1329_48.bin.mat');
...
% 第1高調波成分を抽出
first_harmonic_idx = 2; % 1/20 Hz or 1/25 Hz
