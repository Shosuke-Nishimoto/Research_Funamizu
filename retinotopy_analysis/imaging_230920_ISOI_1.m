[X,cmap] = imread("D:\Nishimoto_data\ISOI\230920_ISOI_1\230920_ISOI_1_tiff\230920_ISOI_1_X1.tif");
X = imresize(X, 1/8);
X = ind2rgb(X,cmap);
figure;
imshow(X)
%%
imds = imageDatastore("D:\Nishimoto_data\ISOI\230920_ISOI_1\230920_ISOI_1_tiff");
im_list = imds.Files;
...
load('230920_ISOI_1.mat')
load('NI_20-Sep-2023_1257_12.bin.mat');
