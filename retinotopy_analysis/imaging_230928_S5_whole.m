...
%     raw_data(:,:,i) = imresize(temp, 1/8);
    ...
    raw_data(:,:,i) = temp(30:230,30:220);
%     WaitMessage.Send;
end
% WaitMessage.Destroy

%%
save_filename = "230926_S5_b1_whole";
...
load("D:\Nishimoto_data\ISOI\230926_S5_f1\230926_S5_f1_whole.mat")
...
load("D:\Nishimoto_data\ISOI\230926_S5_b1\230926_S5_b1_whole.mat")
