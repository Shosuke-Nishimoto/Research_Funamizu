[X,cmap] = imread("D:\Nishimoto_data\ISOI\230920_ISOI_4\230920_ISOI_4_tiff\230920_ISOI_4_X1.tif");
X = imresize(X, 1/8);
X = ind2rgb(X,cmap);
figure;
imshow(X)
%%
imds = imageDatastore("D:\Nishimoto_data\ISOI\230920_ISOI_4\230920_ISOI_4_tiff");
im_list = imds.Files;
...
load('230923_ISOI_S5_1.mat')
load('NI_23-Sep-2023_1608_08.bin.mat');
...
max_stim_num = 750; % 30Hzだから1200の半分
...
%%
[X,cmap] = imread("D:\Nishimoto_data\ISOI\230923_ISOI_S5_1\230923_ISOI_S5_1_tif\230923_ISOI_S5_1_X1.tif");
X = imresize(X, 1/8);
X = ind2rgb(X,cmap);
% 配列のサイズを取得
