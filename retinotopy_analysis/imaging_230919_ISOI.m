...
imshow(X)
%%
imds = imageDatastore("D:\Nishimoto_data\ISOI\230915_ISOI_1\230915_ISOI_1_tiff");
im_list = imds.Files;
...
% inverse アリの場合
stim_frames = length(estim_num_stimuli) - 2*max_stim_num; % inverse刺激以外
