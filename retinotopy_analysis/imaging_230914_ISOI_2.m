[X,cmap] = imread("D:\Nishimoto_data\ISOI\230914_ISOI_2\230914_ISOI_2_tiff\230914_ISOI_2_X1.tif");
X = imresize(X, 1/8);
X = ind2rgb(X,cmap);
figure;
imshow(X)
%%
imds = imageDatastore("D:\Nishimoto_data\ISOI\230914_ISOI_2\230914_ISOI_2_tiff");
im_list = imds.Files;
...
load('230914_ISOI_2.mat')
load('NI_14-Sep-2023_1805_19.bin.mat');
