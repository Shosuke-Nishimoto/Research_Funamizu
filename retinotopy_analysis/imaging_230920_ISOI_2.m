[X,cmap] = imread("D:\Nishimoto_data\ISOI\230920_ISOI_2\230920_ISOI_2_tiff\230920_ISOI_2_X1.tif");
X = imresize(X, 1/8);
X = ind2rgb(X,cmap);
figure;
imshow(X)
%%
imds = imageDatastore("D:\Nishimoto_data\ISOI\230920_ISOI_2\230920_ISOI_2_tiff");
im_list = imds.Files;
...
load('230920_ISOI_2.mat')
load('NI_20-Sep-2023_1342_20.bin.mat');
