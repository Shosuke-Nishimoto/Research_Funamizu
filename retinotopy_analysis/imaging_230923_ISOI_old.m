...
imshow(X)
%%
imds = imageDatastore("D:\Nishimoto_data\ISOI\230923_ISOI_S6_2\230923_ISOI_S6_2_tif");
im_list = imds.Files;
...
%%
save_filename = "230923_ISOI_S6_2";
...
load('230923_ISOI_S5_2.mat')
load('NI_23-Sep-2023_1634_10.bin.mat');
...
%%
[X,cmap] = imread("D:\Nishimoto_data\ISOI\230923_ISOI_S5_2\230923_ISOI_S5_2_tif\230923_ISOI_S5_2_X1.tif");
X = imresize(X, 1/8);
X = ind2rgb(X,cmap);
% 配列のサイズを取得
