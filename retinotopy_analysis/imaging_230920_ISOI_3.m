[X,cmap] = imread("D:\Nishimoto_data\ISOI\230920_ISOI_3\230920_ISOI_3_tiff\230920_ISOI_3_X1.tif");
X = imresize(X, 1/8);
X = ind2rgb(X,cmap);
figure;
imshow(X)
%%
imds = imageDatastore("D:\Nishimoto_data\ISOI\230920_ISOI_3\230920_ISOI_3_tiff");
im_list = imds.Files;
...
load('230920_ISOI_3.mat')
load('NI_20-Sep-2023_1443_43.bin.mat');
