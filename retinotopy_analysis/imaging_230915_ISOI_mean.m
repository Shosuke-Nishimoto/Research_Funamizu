[X,cmap] = imread("D:\Nishimoto_data\ISOI\230914_ISOI_1\230914_ISOI_1_tiff\230914_ISOI_1_X1.tif");
X = imresize(X, 1/8);
X = ind2rgb(X,cmap);
figure;
imshow(X)
...
imds = imageDatastore("D:\Nishimoto_data\ISOI\230914_ISOI_1\230914_ISOI_1_tiff");
im_list = imds.Files;
...
load('230914_ISOI_1.mat')
load('NI_14-Sep-2023_1734_17.bin.mat');
...
figure;
plot(1:max_stim_num, image_data_inv_azimuth(:,:))
figure;
plot(1:max_stim_num, image_data_inv_altitude(:,:))
...
L = max_stim_num; % Length of signal
